...
> ✅ **Works out of the box**: just put `index.html` on any static host and open/deploy it.
...
> ✅ **Готов из коробки**: поместите `index.html` в любой статический хостинг и просто откройте/разверните.
